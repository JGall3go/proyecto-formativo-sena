    ...
    public function index(Request $request)
    {
        ...
        function busquedaDB($busqueda){
            ...
            foreach ($data['permisos'] as $permiso) {
                ...
                if ($permiso->permiso == 'Ver Clientes') { $data['puedeVer'] = 1; }

                if ($permiso->permiso == 'Crear Clientes') { $data['puedeCrear'] = 1; }

                if ($permiso->permiso == 'Editar Clientes') { $data['puedeEditar'] = 1; }

                if ($permiso->permiso == 'Borrar Clientes') { $data['puedeBorrar'] = 1; }
