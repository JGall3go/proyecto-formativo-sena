        ...
        <div class="tableHeaderContent">
            ...
            <div class="searchBar">
                <form action="{{ route('cliente.index') }}" method="GET" class="searchForm">
                    <input type="text" name="busqueda" class="searchInput" value="{{session('busqueda3')}}" placeholder="Buscar..." autocomplete="off">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>@if($perfil->telefono == null) vacio @else {{ $perfil->telefono }} @endif</td>
                    <td>@if($perfil->documento == null) vacio @else {{ $perfil->tipoDocumento }} - {{ $perfil->documento }}@endif</td>
                    <td>@if($perfil->ciudad == null || $perfil->direccion == null) vacio @else {{ $perfil->ciudad }} - {{ $perfil->direccion}} @endif </td>
                    <td>{{ $perfil->email}}</td>
                    <td>{{ $perfil->rol}}</td>
