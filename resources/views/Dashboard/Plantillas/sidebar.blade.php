...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div id="sidebarItems">
            ...
            <a href="/dashboard/home" id="initialItem" @if(str_contains(url()->current(), '/dashboard/home'))class="active"@else class="a"@endif> <img src="{{ asset('svg/home-outline.svg') }}" id="ionIconElement"> <span class="textElementMenu" id="spanCollect">Home</span></a>
