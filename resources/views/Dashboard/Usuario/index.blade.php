...
<section class="contentDashboard">
    ...
    <div class="topBar" id="topBar">
        <div class="breadCrumbs">
            <span style="color: #b9b9b9; font-size: 12px; font-weight: 600;">Dashboard</span> <span style="color: #818181; font-size: 12px; font-weight: 600;">/ Usuario</span>
            <div><h3 style="margin-top: 0px; color: #707070">Usuarios</h3></div>
        </div>
    ...
    <div class="tableContent">
        ...
        <div class="tableHeaderContent">
            ...
            <div class="firstSection">
                ...
                <a onclick="showForm()" class="createLink"><svg xmlns="http://www.w3.org/2000/svg" class="addIcon" viewBox="0 0 512 512"><title>Add</title><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="64" d="M256 112v288M400 256H112"/></svg><span>Usuario</span></a>
            </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actionButton">
                        ...
                        <div>
                            <form action="{{ url('dashboard/usuario/'.$perfil->idPerfil.'/edit') }}">
                            ...
                            <form action="{{ url('dashboard/usuario/'.$perfil->idPerfil) }}" method="POST">
                                {{ method_field('DELETE')}}
                                {{ csrf_field() }}
    ...
    <div class="forms" @isset($formDisplay)style="display: flex"@endisset>
        <div class="createForm">
            ...
            <form action="{{url('/dashboard/usuario')}}" method="POST" enctype="multipart/form-data" class="form">
                ...
                @csrf
                @include('dboardPlantillas/createForm', ['usuario' => 'Usuario'])
        ...
        <div class="updateForm" @isset($formDisplay)style="display: flex" @endisset>
            ...
            <form @isset($perfilesEdit) action="{{ url('dashboard/usuario/'.$perfilesEdit->idPerfil) }}" method="POST" @endisset enctype="multipart/form-data" class="form" id="secondForm">
                ...
                @include('dboardPlantillas/updateForm', ['usuario' => 'Usuario', 'edit' => $perfilesEdit])
