...
<section class="contentDashboard">
    ...
    <div class="tableContent">
        ...
        <div class="tableHeaderContent">
            ...
            <div class="firstSection">
                ...
                <a onclick="showForm()" class="createLink"><svg xmlns="http://www.w3.org/2000/svg" class="addIcon" viewBox="0 0 512 512"><title>Add</title><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="64" d="M256 112v288M400 256H112"/></svg><span>Producto</span></a>
            </div>
    ...
    <div class="forms" @isset($formDisplay)style="display: flex"@endisset>
        ...
        <div class="formBackground" onclick="showForm()"></div>

        <div class="createForm" id="product">

            <form action="{{url('/dashboard/producto')}}" method="POST" enctype="multipart/form-data" class="form">
                ...
                <div class="tagsContainer">
                    <input name="keys" type="text" id="inputAllTags" autocomplete="off">
                    ...
                    <div class="addTagSection" id="addTagSection">
                        <input onkeydown="createTag(event)" id="addTagInput" type="text" autocomplete="off" placeholder="Añadir nueva clave de producto...">
                        <div onclick="createTag(event)" class="addTagButton"><svg xmlns="http://www.w3.org/2000/svg" class="addTagIcon" viewBox="0 0 512 512"><title>Add</title><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M256 112v288M400 256H112"/></svg></div>
                    </div>
        ...
        <div class="updateForm" @isset($formDisplay)style="display: flex" @endisset>
            ...
            <form @isset($productosEdit) action="{{ url('dashboard/producto/'.$productosEdit->idProducto) }}" method="POST" @endisset enctype="multipart/form-data" class="form" id="secondForm">
    ...
    <p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p>
    <p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p><p>Text</p>
