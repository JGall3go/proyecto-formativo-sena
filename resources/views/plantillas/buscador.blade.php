...
<header class="header_container">
    ...
    <div class="menu_header">
        ...
        <a class="navegacion_link animate__animated animate__backInLeft"  href="{{ route('condicion') }}">Terminos y condiciones</a>
    ...
    margin-left: 65%;">
        ...
        <li class="nav-item dropdown" style="background-color: #9256F0; border-radius: 20px;">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="width: 450px; padding: 0px; border-color:#9256F0">
    ...
    <div class="login_container">
        ...
        @else
            <a href='/login' class="btn btn-outline-success animate__animated animate__shakeY animate__delay-2s">Login</a>
        @endauth
