    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <p>
                        <b><a href="/store/{{ $item->attributes->slug }}">{{ $item->titulo
}}</a></b><br>
                        <b>Price: </b>${{ $item->valor }}<br>
                    ...
                    <div class="row">
                        <form action="{{ route('cart.update') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <button class="btn btn-secondary btn-sm" style="margin-right:25px; width:40px;"><i class="fa fa-edit"></i></button>
                            </div>
                        </form>
                        <form action="{{ route('cart.remove') }}" method="POST">
                            {{ csrf_field() }}
                            <input type="hidden" value="{{ $item->idProducto }}" id="idProducto" name="idProducto">
                            <button class="btn btn-dark btn-sm" style="margin-right: 10px; width:40px;"><i class="fa fa-trash"></i></button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5">
            ...
            <a href="{{route('pago')}}" class="btn btn-success">Proceder al Checkout</a> <!-- metodo de pago -->
        </div>
        @endif
    </div>
    <br><br>
