    ...
    <div class="tableContent">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span @if($cliente->estado == "Activo")class="activeState"@else class="inactiveState" @endif>{{ $cliente->estado}}<span></td>
                    ...
                    <td class="actionButton">
                        ...
                        <form action="{{ url('dashboard/cliente/'.$cliente->idCliente.'/edit') }}">
                        ...
                        <form action="{{ url('dashboard/cliente/'.$cliente->idCliente) }}" method="POST">
                            {{ method_field('DELETE')}}
                            {{ csrf_field() }}
        ...
        <div class="paginatorButtons">
            ...
            @php
                ...
                $registrosTotales = count($clientesTotales);
                $clientesActuales = count($clientes);
                $registros = count($clientesTotales) / session('paginate');
                ...
                echo "<p class='paginatorText'>Mostrando $clientesActuales de $registrosTotales registros</p>";
    ...
    <div class="forms">
        <div class="createForm">
            <form action="{{url('/dashboard/cliente')}}" method="POST" enctype="multipart/form-data" class="form">
                ...
                <div class="inputContainer">
                    <input type="email" class="input" value="Cliente" style="color: #b8b8b9" autocomplete="off" readonly>
        ...
        <div class="updateForm">
            ...
            <form @isset($clientesEdit) action="{{ url('dashboard/cliente/'.$clientesEdit->idCliente) }}" method="POST" @endisset enctype="multipart/form-data" class="form" id="secondForm">
                ...
                <div class="updateButtonContainer">
                    <input type="submit" class="updateButton" value="Actualizar" @isset($clientesEdit) @else disabled @endisset> <a class="cancelButton" @isset($clientesEdit) href="/dashboard/cliente" @endisset>Cancelar</a>
                </div>
            </form>
        </div>
    </div>
